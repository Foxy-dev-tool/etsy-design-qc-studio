        ...
        <div className="lg:col-span-4 space-y-4">
          <div className="bg-white border border-slate-200 rounded-xl p-4 space-y-3 shadow-sm">
            <span className="text-xs font-extrabold text-slate-600 uppercase tracking-wider block">
              Danh Sách Nhóm Sản Phẩm ({productGroups.length})
            </span>
            ...
            <div className="space-y-2">
              {productGroups.map((group, idx) => (
                ...
                >
                  ...
                  {group.baseMockup && (
                    <img
                      src={getSafeImgSrc(group.baseMockup)}
                      alt="Mockup"
          ...
          <div className="bg-white border border-slate-200 rounded-xl p-5 space-y-4 shadow-sm">
            ...
            <div className="space-y-2">
              ...
              <div className="flex items-center gap-4 bg-slate-50 p-3 rounded-xl border border-slate-200">
                <img
                  src={getSafeImgSrc(activeGroup.baseMockup) || '/_4123920413.png'}
                  alt="Base Mockup"
          ...
          <div className="bg-white border border-slate-200 rounded-xl p-5 space-y-4 shadow-sm">
            <div className="flex items-center justify-between pb-2 border-b border-slate-100">
              <h3 className="text-sm font-extrabold text-slate-900 flex items-center gap-2">
                ...
                <span>2. Danh Mục Template Kích Thước Sản Phẩm ({activeGroup.templates?.length || 0} Size)</span>
              </h3>
            ...
            <div className="space-y-3">
              {activeGroup.templates?.map((tmpl, idx) => {
                const imgPath = tmpl.templateImage || tmpl.templateFile || '';
                return (
                  <div key={idx} className="bg-slate-50 p-4 rounded-xl border border-slate-200 space-y-3">
                    ...
                    <div className="flex items-center gap-3 pt-1">
                      ...
                      <div className="flex-1">
                        ...
                        <span className="text-[10px] text-slate-500 truncate block max-w-sm font-mono">
                          {imgPath || 'Chưa chọn file template'}
                        </span>
                      </div>
